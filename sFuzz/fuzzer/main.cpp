...
#include "Utils.h"
#include <filesystem>  // 新增，用于遍历子文件夹
...
static int DEFAULT_ANALYZING_INTERVAL = 1; // 5 sec
...
int main(int argc, char* argv[]) {
  ...
  /* Fuzz contracts in each subfolder */
